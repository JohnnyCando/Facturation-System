...
import {UpdateUserComponent} from "../../../Web/src/app/update-user/update-user.component";
import { RegisterSalesNotesComponent } from './salesNotes/register-sales-notes/register-sales-notes.component';
import { GetSalesNotesByUserComponent } from './salesNotes/get-sales-notes-by-user/get-sales-notes-by-user.component';
import { RegisterSalesNotesProvComponent } from './salesNotes/register-sales-notes-prov/register-sales-notes-prov.component';
...
const appRoutes: Routes = [
  ...
  {path: 'services/registerProductInWine', component: DeleteServicesComponent},
  {path: 'services/GetProductsInWineries', component: UpdateSubServicesComponent},
  {path: 'services/registerSaleNote', component: RegisterSalesNotesComponent},
...
@NgModule({
  declarations: [
    ...
    RegisterSalesNotesComponent,
    GetSalesNotesByUserComponent,
    RegisterSalesNotesProvComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
